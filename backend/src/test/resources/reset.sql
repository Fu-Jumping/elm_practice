...
-- u001 保持非会员（保证既有订单金额断言不被会员折扣影响）；u002 为会员测试用户（契约 §3.8，账号 13800000003）。
INSERT INTO users(user_id,account,password_hash,nickname,created_at,is_member,member_activated_at) VALUES
('u001','13800000001','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','演示用户',NOW(),FALSE,NULL),
('u002','13800000003','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','会员用户',NOW(),TRUE,DATE_SUB(NOW(),INTERVAL 10 DAY))
ON DUPLICATE KEY UPDATE nickname=VALUES(nickname),is_member=VALUES(is_member),member_activated_at=VALUES(member_activated_at);
