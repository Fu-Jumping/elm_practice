...
-- 应用启动时仅当 users 表为空才执行（DatabaseInitializer 控制），避免重启重置运行期数据。
-- 注意：本文件与 backend/database/seed/seed.sql 保持同步，修改需同步两处。
...
('m001',NULL,'老王小店','家常菜与便当',4.60,1000,30,20.00,3.00,'/demo-images/store-m001.jpg','OPEN'),
('m002','ma001','肯德基宅急送','吮指原味鸡，宅家也能吃',4.80,1000,30,20.00,3.00,'/demo-images/store-m002.jpg','OPEN'),
('m003',NULL,'麦当劳','经典汉堡套餐',4.70,1000,30,20.00,3.00,'/demo-images/store-m003.jpg','OPEN'),
('m004',NULL,'老胖烧烤','夜宵烧烤外卖',4.50,1000,30,20.00,3.00,'/demo-images/store-m004.jpg','TEMPORARILY_CLOSED'),
('m005',NULL,'元盛居火锅','鲜切羊肉火锅',4.60,1000,30,20.00,3.00,'/demo-images/store-m005.jpg','OPEN')
...
('p101','m002','c102','吮指原味鸡','经典美味','/demo-images/product-m002-06.jpg',29.00,20,TRUE,120),
('p102','m002','c102','香辣鸡翅','外酥里嫩','',19.00,20,TRUE,88),
('p103','m002','c102','黄金鸡块','分享装','/demo-images/product-m002-04.jpg',16.00,30,TRUE,75),
('p104','m002','c102','可乐（中杯）','冰爽可口','/demo-images/product-m002-05.jpg',8.00,40,TRUE,140),
('p105','m002','c102','劲脆鸡腿堡','现做汉堡','/demo-images/product-m002-02.jpg',25.00,15,TRUE,64),
('p111','m001','c101','红烧肉套餐','米饭配例汤','/demo-images/product-m001-04.jpg',26.00,20,TRUE,96),
('p112','m001','c101','番茄炒蛋饭','酸甜下饭','/demo-images/product-m001-06.jpg',18.00,20,TRUE,132),
('p113','m001','c101','宫保鸡丁饭','微辣经典','/demo-images/product-m001-05.jpg',22.00,20,TRUE,105),
('p114','m001','c101','紫菜蛋花汤','清爽暖胃','',6.00,40,TRUE,88),
('p131','m003','c103','巨无霸套餐','汉堡+薯条+可乐','/demo-images/product-m003-01.jpg',33.00,20,TRUE,150),
('p132','m003','c103','麦辣鸡腿堡','香辣过瘾','',24.00,20,TRUE,118),
('p133','m003','c103','薯条（大）','金黄酥脆','/demo-images/product-m003-03.jpg',13.00,30,TRUE,200),
('p134','m003','c103','可口可乐','冰爽畅饮','',9.00,40,TRUE,210),
('p141','m004','c104','羊肉串（10串）','炭火现烤','/demo-images/product-m004-01.jpg',28.00,20,TRUE,140),
('p142','m004','c104','烤鸡翅','外焦里嫩','',18.00,20,TRUE,110),
('p143','m004','c104','烤茄子','蒜香浓郁','/demo-images/product-m004-02.jpg',12.00,30,TRUE,95),
('p144','m004','c104','冰镇啤酒','夜宵伴侣','',10.00,40,TRUE,160),
('p151','m005','c105','鲜切羊肉（半斤）','每天现切','/demo-images/product-m005-02.jpg',68.00,15,TRUE,80),
('p152','m005','c105','麻辣锅底','牛油麻辣','',38.00,20,TRUE,90),
('p153','m005','c105','手切牛上脑','纹理细腻','/demo-images/product-m005-01.jpg',58.00,15,TRUE,72),
('p154','m005','c105','冻豆腐','吸汤入味','',8.00,30,TRUE,60)
ON DUPLICATE KEY UPDATE name=VALUES(name),image=VALUES(image),price=VALUES(price),stock=VALUES(stock),on_sale=VALUES(on_sale);
...
('o1001','p101','吮指原味鸡','/demo-images/product-m002-06.jpg','c102',29.00,1),
('o1002','p102','香辣鸡翅','','c102',19.00,1),
('o1003','p105','劲脆鸡腿堡','/demo-images/product-m002-02.jpg','c102',25.00,1)
ON DUPLICATE KEY UPDATE name=VALUES(name),image=VALUES(image),unit_price=VALUES(unit_price),quantity=VALUES(quantity);
