...
public class AuthController {
    private final AuthService auth; private final StoreService stores;
    public AuthController(AuthService auth, StoreService stores){this.auth=auth;this.stores=stores;}
